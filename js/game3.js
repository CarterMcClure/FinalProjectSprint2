(function ($) {
    ...
    var assetLoader = (function() {
      // images dictionary
      this.imgs        = {
        'bg'            : 'img/runner_img/bg.png',
        'sky'           : 'img/runner_img/sky.png',
        'backdrop'      : 'img/runner_img/backdrop.png',
        'backdrop2'     : 'img/runner_img/backdrop_ground.png',
        'grass'         : 'img/runner_img/grass.png',
        'avatar_normal' : 'img/runner_img/normal_walk.png',
        'water'         : 'img/runner_img/water.png',
        'grass1'        : 'img/runner_img/grassMid1.png',
        'grass2'        : 'img/runner_img/grassMid2.png',
        'bridge'        : 'img/runner_img/bridge.png',
        'plant'         : 'img/runner_img/plant.png',
        'bush1'         : 'img/runner_img/bush1.png',
        'bush2'         : 'img/runner_img/bush2.png',
        'cliff'         : 'img/runner_img/grassCliffRight.png',
        'spikes'        : 'img/runner_img/spikes.png',
        'box'           : 'img/runner_img/boxCoin.png',
        'slime'         : 'img/runner_img/slime.png'
      };
    
      // sounds dictionary
      this.sounds      = {
        'bg'            : 'audio/runner_audio/bg.mp3',
        'jump'          : 'audio/runner_audio/jump.mp3',
        'gameOver'      : 'audio/runner_audio/gameOver.mp3'
      };
    ...
    var player = (function(player) {
      ...
      // spritesheets
      player.sheet     = new SpriteSheet('img/runner_img/normal_walk.png', player.width, player.height);
